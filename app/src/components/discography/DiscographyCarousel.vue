...
export default defineComponent({
  ...
  data() {
    return {
      ...
      contents: [
        {
          no: 4, title: "花髪のロラ", description: "人は花に魅せられる話。", imagePath: "src/assets/jacket_lora.png", eventName: "THE VOC@LOiD M@STER53", links: []
        }, {
          no: 3, title: "夜明け、駅前。", description: "駅前で待つ朝の話。", imagePath: "src/assets/jacket_yoakeekimae.png", eventName: "M3-2022秋", links: [
          ...
          no: 2, title: "藍譚", description: "夏に残した燈の話。", imagePath: "src/assets/jacket_lantern.png", eventName: "M3-2021秋", links: [
            { icon: "mdi:youtube", url: "https://youtu.be/ACK8eofMkrs" },
            { icon: "simple-icons:niconico", url: "https://www.nicovideo.jp/watch/sm39527910" },
            { icon: "mdi:cart", url: "https://www.melonbooks.co.jp/detail/detail.php?product_id=1684364" },
          ]
        }, {
          no: 1, title: "雪狼", description: "", imagePath: "src/assets/jacket_setsuro.png", eventName: "M3-2020秋", links: [
            { icon: "mdi:youtube", url: "https://youtu.be/JdW1aMtQHHE" },
            { icon: "simple-icons:niconico", url: "https://www.nicovideo.jp/watch/sm37711126" },
            { icon: "mdi:cart", url: "https://www.melonbooks.co.jp/detail/detail.php?product_id=1684364" },
          ]
        }, {
          no: 0, title: "僕らの飛行計画", description: "", imagePath: "src/assets/jacket_hikoukeikaku.png", eventName: "M3-2019春", links: []
        },
      ]
    }
  },
